...
const TestCourseById = (): JSX.Element => {
    return <div>TestCourseById</div>;
};

export default TestCourseById;
...
//     const adjustPositions = (courseData: CoursesDTOGeojson[]) => {
...
//                 },
//             });
//             log.info('Points layer added:', validData.length); // Log pour vérifier le nombre de points ajoutés
...
//                 log.info('Point coordinates:', coords); // Log les coordonnées

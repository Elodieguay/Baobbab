...
import { ContentDisplay } from '@/pages/dashboard/ContentDisplay';
...
export function AppSidebar({
    ...
    const [activeItem, setActiveItem] = useState<string | null>('Playground'); // Définit l'élément actif par défaut
    return (
